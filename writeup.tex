...
\comment{TODO: Bob points out we should clarify that we don't deal with new mutation (if there was it'd be unconstrained in distribution)}
...
By contrast, in \citet{fisher1918correlation} and \citet{barton2017infinitesimal} \revpoint{2}{10}, the scaled allelic effect at any locus $\ell$ has magnitude bounded by $\frac{B}{\sqrt{M}}$, and thus, no matter how many alleles one considers, there will be no large effect alleles that are informative of the trait value.  


To summarize, the key argument in \citet{fisher1918correlation} and \citet{barton2017infinitesimal}  \revpoint{1}{10}
...
However, examination of Figure~\ref{fig:exponent_hist} suggests that $\alpha=3/2$ \revpoint{2}{12}
