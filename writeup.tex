...
On the other hand, the largest of $n$ Gaussians is of order $\sqrt{\log n}$. \revpoint{2}{1} \revpoint{1}{11}
...
In fact, many traits that have been claimed to be mostly genetically determined \revpoint{1}{14}
