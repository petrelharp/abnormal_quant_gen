...
\comment{Make the point that another way to think about distibutions with non-finite variance
...
perhaps the distribution of effect sizes within each gene is Normal, \revpoint{1}{13}
...
in the infinitesimal model. \revpoint{1}{1} \revpoint{1}{2}
...
is between 20 and 10\% of all SNPs). \revpoint{2}{3}
...
although in practice this would quickly create dependencies between nearby allelic effects. \revpoint{2}{5}
